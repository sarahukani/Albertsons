...
return(
    <div className="scroll-div">
        ...
        <div className="detailedDescrip">
            ...
            <img alt="age-input-examples" onMouseOver={openAge} onMouseLeave={closeAge} className="ageInfoIcon" src="https://cdn-icons-png.flaticon.com/512/471/471662.png"/>
            <h3 className="ageName">Demographic:</h3>
            <input className="age" onChange={handleAgeChange}></input>
            
            <img alt="product-input-examples" onMouseOver={openProduct} onMouseLeave={closeProduct} className="productInfoIcon" src="https://cdn-icons-png.flaticon.com/512/471/471662.png"/>
            <h3 className="productName">Product Category:</h3>
            <input className="productCategory" onChange={handleProductChange}></input>
            
            <img alt="weather-input-examples" onMouseOver={openWeather} onMouseLeave={closeWeather} className="weatherInfoIcon" src="https://cdn-icons-png.flaticon.com/512/471/471662.png"/>
            <h3 className="weatherName">Weather:</h3>
            <input className="weather" onChange={handleWeatherChange}></input>
            
            <img alt="holiday-input-examples" onMouseOver={openHoliday} onMouseLeave={closeHoliday} className="holidayInfoIcon" src="https://cdn-icons-png.flaticon.com/512/471/471662.png"/>
        ...
        <div className="reccomendations">
            ...
            <img alt="" className="recImg" src={recommendation.imageURL}/>
            )}
        </div>

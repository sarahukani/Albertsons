...
export default function Icon(props) {
  //props param to pass in store name from main

  const acme =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Acme_Markets_lolo.svg/1200px-Acme_Markets_lolo.svg.png";

  const albertsons =
    "https://companieslogo.com/img/orig/ACI_BIG-e23b19be.png?t=1597359298";

  const vons =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Vons_logo.svg/1280px-Vons_logo.svg.png";

  const jewelOsco =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Jewel-Osco_logo.svg/1200px-Jewel-Osco_logo.svg.png";

  const marketStreet =
    "https://unitedcloud.relationshop.net/RSData/Store/20200923134659_MSLogo.png";

  const safeway =
    "https://logos-world.net/wp-content/uploads/2022/01/Safeway-Logo.png";

  const shaws =
    "https://assets.stickpng.com/images/62fe5219f31142d937b30c5e.png";

  const tomThumb =
    "https://www.nicepng.com/png/full/139-1394458_tom-thumb-logo-tom-thumb-store-logo.png";

  const unitedSuper =
    "https://upload.wikimedia.org/wikipedia/en/thumb/f/f5/United_Supermarkets_logo.svg/1200px-United_Supermarkets_logo.svg.png";

  const unitedExpress =
    "https://www.theunitedfamily.com/wp-content/uploads/2018/12/unitedexpress_logo.png";

  const randalls =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Randalls_new_logo.svg/2560px-Randalls_new_logo.svg.png";

  const albertsonsMarket =
    "https://www.albertsonsmarket.com/Themes/AlbertsonsMarket5/Content/Images/Default-Logo.png";

  const pavillions =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Pavilions_%28supermarket%29_Logo.svg/2560px-Pavilions_%28supermarket%29_Logo.svg.png";

  const starMarket =
    "https://seeklogo.com/images/S/Star_Market-logo-A2DE79062C-seeklogo.com.png";

  const kings =
    "https://upload.wikimedia.org/wikipedia/en/thumb/0/09/Kings_Food_Markets_logo.svg/1200px-Kings_Food_Markets_logo.svg.png";

  const haggen =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Haggen_logo.svg/1280px-Haggen_logo.svg.png";

  const carrs =
    "https://assets.stickpng.com/thumbs/62fe4dd4f31142d937b30c3f.png";

  const andronico =
    "https://cdn.winsightmedia.com/platform/files/public/gb/News/Andronicos-Community-Markets-Surpasses-1M-in-Instacart-Sales/ACM_logo_CMYK-2.gif";

  const balducci =
    "https://www.purered.net/wp-content/uploads/2019/03/logo_balduccis.png";

  const lucky =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Lucky_Stores_logo.svg/1200px-Lucky_Stores_logo.svg.png";

  const amigos =
    "https://www.amigosunited.com/Themes/Amigos5/Content/Images/Default-Logo.png";

  const albertsonsMarketStreet =
    "https://www.instacart.com/assets/domains/store_configuration/logo/170/white_label_landing_page_d1036021-fe23-404c-b403-b9e7eb3b6750.png";
